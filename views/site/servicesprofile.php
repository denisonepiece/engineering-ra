...
<div class="modal_div" id="modal2">
    <div class="modal-container__modal-dialog">
        <div class="modal-dialog__modal-header">
            ...
            <h1 class="header-block">Подать заявку Виджет</h1>
        </div>
        <div class="modal-dialog__modal-body">
            <div class="btn-group">
                <a href="#modal3" class="btn one-btn open_modal">Проконсультрироваться</a>
            </div>                                
            <div class="btn-group">
                 <a href="#modal1" class="btn one-btn open_modal">Получить услугу</a>
             </div>
        </div>
                    ...
                    <div class="services__under-header">
                        ...
                        <div class="under-header__right">
                            ...
                            <div class="right__footer">
                                <div class="btn-group">
                                    <a href="#modal1" class="btn one-btn open_modal">Подать заявку</a>
                                </div>
                            </div>
