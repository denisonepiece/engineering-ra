                        ...
                        <div class="services__under-header">
                            ...
                            <!-- Правый блок для событий СТАРТ -->
                                ...
                                <div class="right__info">
                                    ...
                                    <div class="info__right">
                                            <div class="right__position">
                                                <div class="position__name">Заявку на участия можно подать:</div>
                                ...
                                <?php
                                    ...
                                    ?>
                                    <!-- Правый блок для событий КОНЕЦ -->


                                    <!-- Правый блок для новостей СТАРТ -->
                                        <div class="right__info">
                                            <div class="info__left">
                                                <div class="left__position">
                                                ...
                                                <div class="left__position">
                                                    ...
                                                    <div class="position__desc">
                                                        <div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,twitter" data-counter="">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Правый блок для новостей КОНЕЦ -->
                                    <?php
                                }
?>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-12 col-xs-12">
                    <div class="news-tile__text base-text for-content-ptop">
                        <?= $news->content ?>
                    </div>
                </div>
            </div>
